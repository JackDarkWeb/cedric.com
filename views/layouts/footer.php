  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 d-none d-md-block">
        <h2 class="row"><a href="/" class="nav-link rounded-circle py-5" style="background-color: #000;">CEDRIC</a></h2>
      </div>

      <div class="col-md-8">
        <div class="row">
          <div class="col-6 col-lg-3">
            <a class="nav-link text-center text-md-left row a" href="/coaching">Coaching</a>
          </div>
          <div class="col-6 col-lg-3">
            <a class="nav-link text-center text-md-left row a" href="/formation">Formations</a>
          </div>
          <div class="col-6 col-lg-3">
            <a class="nav-link text-center text-md-left row a" href="/shop">La boutique</a>
          </div>
          <div class="col-6 col-lg-3">
            <a class="nav-link text-center text-md-left row a" href="/event">Événements</a>
          </div>
        </div>

...
<div class="all-nav fixed-top">
    ...
    <div class="nav2">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="/"><h1>CEDRIC</h1></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item btn-group dropdown">
              <a class="nav-link" href="/shop">La boutique</a>
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="/audio">Audios</a>
                <a class="dropdown-item" href="/video">Vidéos</a>
                <a class="dropdown-item" href="/book">Livres</a>
              </div>
            </li>
          </ul>
